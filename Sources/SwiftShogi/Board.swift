...
public extension Board {
    ...
    func isAttackable(from sourceSquare: Square, to destinationSquare: Square) -> Bool {
        attacksBitboard(from: sourceSquare)[destinationSquare]
    }

    /// Returns the attackable squares from `square`.
    func attackableSuqares(from square: Square) -> [Square] {
        attacksBitboard(from: square).squares
    }

    /// Returns the attackable squares to `square` corresponding to `color`.
    func attackableSquares(to destinationSquare: Square, for color: Color? = nil) -> [Square] {
    ...
    func occupiedSquares(for color: Color? = nil) -> [Square] {
    ...
    func isKingChecked(for color: Color) -> Bool {
    ...
    func isKingCheckedByMovingPiece(from sourceSquare: Square, to destinationSquare: Square, for color: Color) -> Bool {
        var board = self
    ...
    func isKingCheckedByMovingPiece(_ piece: Piece, to destinationSquare: Square, for color: Color) -> Bool {
        var board = self
